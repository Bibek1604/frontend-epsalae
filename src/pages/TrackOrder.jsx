          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="p-6 text-center bg-white border border-gray-100 shadow-sm rounded-2xl">
              <div className="relative inline-flex mb-4">
                <span className={`absolute inset-0 rounded-full bg-gradient-to-br ${cfg.ring} opacity-25 animate-ping`} />
                <span className={`relative flex items-center justify-center w-20 h-20 rounded-full shadow-lg bg-gradient-to-br ${cfg.ring}`}>
  ...
  return (
    <div className="flex items-start gap-3 p-3 border border-gray-100 rounded-xl bg-gray-50/60">
      ...
      <div className="min-w-0">
        ...
        <p className={`text-sm font-semibold text-gray-900 break-words ${mono ? 'font-mono' : ''}`}>{value}</p>
      </div>
    </div>
  );
}
