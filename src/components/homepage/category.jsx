...
function CategoryCard({ cat, index, navigate }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex aspect-square items-center justify-center overflow-hidden bg-[linear-gradient(180deg,_rgba(248,250,252,0.95)_0%,_rgba(255,255,255,1)_100%)] p-6 sm:p-7">
        ...
        <div className="absolute h-px inset-x-6 top-6 bg-gradient-to-r from-transparent via-slate-200 to-transparent opacity-70" />
        <img
          src={imgSrc}
          alt={cat.name}
