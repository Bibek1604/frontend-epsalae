    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
        ...
        >
          ...
          <div className="w-full md:w-1/2 bg-gradient-to-br from-gray-50 to-slate-100 flex items-center justify-center p-6 aspect-square md:aspect-auto">
            <img
...
export default function ProductsGrid() {
  ...
  const handleAddToCart = (product) => {
    if (product.stock > 0) {
      addToCart({ id: product.id, name: product.name, price: product.discountPrice || product.price, image: product.imageUrl, quantity: 1 });
  ...
  if (loading) {
    return (
      <section className="py-8 sm:py-14 bg-gradient-to-b from-white to-gray-50">
    ...
    <section className="py-8 sm:py-14 bg-gradient-to-b from-white to-gray-50">
      <div className="px-3 mx-auto max-w-7xl sm:px-6">
        ...
        <div className="flex flex-col items-start justify-between gap-4 mb-10 sm:mb-12 md:flex-row md:items-center">
          ...
          <Link
            to="/products"
            className="inline-flex items-center gap-2 px-6 py-3 font-bold text-sm text-white bg-gradient-to-r from-[#1A3C8A] to-[#FF6B35] rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all btn-press"
          >
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-4 md:gap-6">
          {displayProducts.map((product, index) => (
            ...
            >
              ...
              >
                <div className="w-full h-full bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center p-4">
                  <ProductImage
                    src={product.imageUrl}
                    alt={product.name}
                ...
                {product.discountPrice > 0 && product.discountPrice < product.price && (
                  <div className="absolute top-3 left-3 px-2.5 py-1 text-[11px] font-extrabold text-white bg-gradient-to-r from-red-500 to-rose-600 rounded-lg shadow-md badge-flash">
